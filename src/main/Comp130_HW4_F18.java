...
public class Comp130_HW4_F18 extends GraphicsProgram {
	 ...
	 */
	public void createrRaid10Discs(GImage image) {
		//Your code starts here
		// Your code ends here
	}
	 ...
	 */
	public void initArray(GImage image) {
...
//		}
	 ...
	 */
	public int[][] createImageRaid0fromOneDisc () {
	 ...
	 */
	public int[][] createImageRaid0fromTwoDiscs () {
	 ...
	 */
	public int[][] createImageRaid1fromOneDisc () {
		int[][] array = new int [imageHeight][imageWidth];
		//printDisc(disc1);
		//printDisc(disc2);
		int arrayRowIndex = 0;
	 ...
	 */
	public int[][] readImageFile (String raidType) {
...
//				}
	 ...
	 */
	public String readPixel(String line, int location) {
		String result = "";
	 ...
	 */
	public void printDisc(int[] disc){
